...
\begin{figure}[h]
	\centering
	{\epsfig{file = umsetzung/images/createproject.png, width=13.0cm}}
...
\begin{figure}[h]
	\centering
	{\epsfig{file = umsetzung/images/sidebar.png, width=8.0cm}}
...
\begin{figure}[h]
	\centering
	{\epsfig{file = umsetzung/images/becher3d.png, width=6.0cm}}
